...
## V1.9.6 — Bỏ bước Sẵn sàng

- Nâng phiên bản từ V1.9.5 lên V1.9.6.
- Bỏ nút **Tôi sẵn sàng**, trạng thái **Đã sẵn sàng** và nút **Hủy sẵn sàng** trong phòng đấu.
- Khi khách chấp nhận lời mời, hệ thống đưa khách vào phòng và chuyển thẳng sang **Trạng thái: Chờ Chủ Phòng Quay**.
- Chủ phòng có thể quay đội Xếp hạng hoặc Giao hữu ngay khi khách đã vào phòng.
- Các endpoint Sẵn sàng cũ vẫn được giữ ở chế độ tương thích để trang/cache cũ không báo lỗi, nhưng không còn thay đổi luồng chính.
- Sau khi khách chấp nhận lời mời, thoát phòng trước khi quay đội được tính là bỏ cuộc theo cơ chế hiện tại.
- Không thêm file SQL; thay đổi này không cần chỉnh cấu trúc Supabase.
