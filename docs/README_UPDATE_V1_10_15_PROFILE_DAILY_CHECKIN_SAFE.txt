V1.10.15_PROFILE_DAILY_CHECKIN_SAFE
...
2. Chạy docs/01_install_v1_10_15_profile_daily_checkin.sql trong Supabase.
3. Chạy docs/02_check_v1_10_15_profile_daily_checkin.sql để kiểm tra.
...
8. Chỉ chạy docs/99_rollback_v1_10_15_profile_daily_checkin.sql nếu muốn xóa hẳn dữ liệu ZCOIN/điểm danh mới.
